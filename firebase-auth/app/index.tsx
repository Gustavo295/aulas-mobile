...
export default function LoginScreen() {
  ...
  const esqueceuSenha = ()=>{
    ...
    sendPasswordResetEmail(auth,email)
      .then(()=> alert("Enviando e-mail para recuperação"))
      .catch((error)=>alert("Erro ao eviar e-mail"))
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{marginTop:20,color:'white',marginLeft:138}} onPress={esqueceuSenha}>Esqueci a Senha</Text>
    </View>
  );
}
